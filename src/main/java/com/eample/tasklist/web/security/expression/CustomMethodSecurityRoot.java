package com.eample.tasklist.web.security.expression;

import com.eample.tasklist.domain.user.Role;
import com.eample.tasklist.service.UserService;
import com.eample.tasklist.web.security.JwtEntity;
...
public class CustomMethodSecurityRoot
    ...
    public CustomMethodSecurityRoot(final Authentication authentication) {
